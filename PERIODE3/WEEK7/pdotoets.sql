...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 19 jul 2024 om 15:48
...
INSERT INTO `factuur` (`Factuur_id`, `F_Datum`, `6%Btw`, `19%Btw`, `Totaal_excl_BTW`, `Totaal_incl_BTW`, `Prijs_totaal`, `aantal_producten`, `Tafel_id`, `Product_id`) VALUES
(3, '2024/04/06', 20.00, 50.00, 111.00, 115.00, 300.00, 55, 1, 1),
(5, '2024/04/06', 15.00, 50.00, 155.00, 115.00, 215.00, 5, 1, 1);
...
INSERT INTO `product` (`Product_id`, `omschrijving`, `Prijs_per_stuk`) VALUES
(1, 'melk', 1.00);
...
--
ALTER TABLE `factuur`
  MODIFY `Factuur_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tafel`
  MODIFY `Tafel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
